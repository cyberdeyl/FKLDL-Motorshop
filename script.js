document.addEventListener('DOMContentLoaded', () => {
    const contacts = [
        { name: "Franz Elpa", fb: "https://www.facebook.com/share/18itKULuUD/" },   // F
        { name: "Kristoffer Soriano", fb: "https://www.facebook.com/share/19iAiWnxKK/" }, // K
        { name: "Lyn Tila-on", fb: "https://www.facebook.com/share/19grXEw7Hs/" },  // L
        { name: "Dale Sercena", fb: "https://www.facebook.com/share/17BfZGiPNq/" }, // D
        { name: "Liezel Develuz", fb: "https://www.facebook.com/share/1FQyCFP33b/" } // L
    ];
    ...
    function renderContacts() {
        ...
        // Title para sa contacts
        const title = document.createElement('h3');
        title.textContent = "Contacts (FKLDL)";
        ...
        contacts.forEach(contact => {
            ...
            a.href = contact.fb;
            a.target = "_blank"; // bubukas sa new tab
            a.innerHTML = `<i class="fab fa-facebook" style="color:#1877F2; margin-right:6px;"></i> ${contact.name}`;
            li.appendChild(a);
            ul.appendChild(li);
        });
